...
public class Personne{
    ...
    private static int compterPers = 0;
	...
	//Question3
	public boolean plusAgeeQue (Personne personne3) {
		if(this.dateNaissance.before(personne3.dateNaissance))
			return true;
		else
			return false;
	...
	public boolean equals(Object personne) {
		if(this.nom == ((Personne)personne).getNom() && this.prenom == ((Personne)personne).getPrenom()  && this.dateNaissance == ((Personne)personne).getDateNaissance())
			return true;
		else
			return false;
	}
